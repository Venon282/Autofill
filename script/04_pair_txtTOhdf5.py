...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Convert paired CSV metadata and TXT files into HDF5 format."
    )
    parser.add_argument("--data_csv_path", type=str, required=True, help="Path to the paired metadata CSV file.")
    parser.add_argument("--sep", type=str, default=";", help="Field separator used in the CSV file.")
    parser.add_argument("--data_dir", type=str, required=True, help="Directory containing the TXT files referenced by the CSV.")
    parser.add_argument("--pad_size", type=int, default=500, help="Padding length applied to each curve.")
    parser.add_argument("--final_output_file", type=str, default="data.h5", help="Destination HDF5 filename.")
